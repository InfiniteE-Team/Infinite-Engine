...
class RGBShader {
	...
	public static function applyHexColor(sprite:flixel.FlxSprite, hexColor:Int) {
		...
		var shader = new FlxRuntimeShader(src);
	...
	public static function applyHexString(sprite:flixel.FlxSprite, hexString:String) {
		if (sprite == null || hexString == null) return;
	...
	public static function applyByAnimation(sprite:flixel.FlxSprite, noteSkinData:NoteSkinData, animationName:String) {
		if (sprite == null || noteSkinData == null || animationName == null) return;

		if (noteSkinData.colorPalette != null && noteSkinData.colorPalette.exists(animationName)) {
			var hexString = noteSkinData.colorPalette.get(animationName);
