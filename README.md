...
- [hxscript](https://github.com/MeguminBOT/hxscript) by MeguminBOT
...
- [ALE-Json](https://github.com/AlejoGDOfficial/ALE-Json) by AlejoGDOfficial

**Infinite Team:**
-----------------------
- Manux (Main Coder, and Concepts)
- Nelson (Main Artist)
- Yuning (UI Artist)
- Seevent (Musician)
